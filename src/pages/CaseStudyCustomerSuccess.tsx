      ...
      <main>
        ...
        >
          <div className="container mx-auto px-4 relative z-10">
            <Link to="/" className="inline-flex items-center text-primary-foreground hover:text-primary-foreground/80 mb-6 transition-colors focus-visible-ring">
          ...
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Card className="p-6 text-center">
                ...
                <p className="text-3xl font-bold text-heading mb-2">25</p>
                <p className="text-muted-foreground">New CS Advocates</p>
              </Card>
              <Card className="p-6 text-center">
                <Target className="h-8 w-8 text-secondary mx-auto mb-3" />
                <p className="text-3xl font-bold text-heading mb-2">3-Phase</p>
                <p className="text-muted-foreground">Blended Program</p>
              </Card>
              <Card className="p-6 text-center">
                <TrendingUp className="h-8 w-8 text-secondary mx-auto mb-3" />
                <p className="text-3xl font-bold text-heading mb-2">CSAT</p>
                <p className="text-muted-foreground">Target Maintained</p>
              </Card>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-subtle">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="mb-6">Discovery & Root Cause Analysis</h2>
