        ...
        <section className="py-12 bg-gradient-subtle border-b border-border">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl">
              <h1 className="mb-4">Reporting & Analytics Learning Program</h1>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-heading">Business-First Learning Design</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-heading">Persona-Based Content Strategy</h3>
                  <p className="text-foreground leading-relaxed">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-heading">Data Storytelling Framework</h3>
                  <p className="text-foreground leading-relaxed">
